...
// QMenuBar
  ...
  section = "OpCodeMonitoring";
   ...
   filterMenu->insertItem("Reload &Zone Filters", m_filterMgr, SLOT(loadZoneFilters()), Qt::SHIFT+Qt::Key_F3);
   filterMenu->insertItem("S&ave Zone Filters", m_filterMgr, SLOT(saveZoneFilters()), Qt::SHIFT+Qt::Key_F4);
  ...
  m_terminalMenu->insertItem("Edit User &Message Filters...", 
   ...
   pDebugMenu->insertItem("Dump Spawns", this, SLOT(dumpSpawns()), Qt::ALT+Qt::SHIFT+Qt::CTRL+Qt::Key_P);
   pDebugMenu->insertItem("Dump Drops", this, SLOT(dumpDrops()), Qt::ALT+Qt::SHIFT+Qt::CTRL+Qt::Key_D);
   pDebugMenu->insertItem("Dump Map Info", this, SLOT(dumpMapInfo()), Qt::ALT+Qt::SHIFT+Qt::CTRL+Qt::Key_M);
   ...
   pDebugMenu->insertItem("Dump Group", this, SLOT(dumpGroup()), Qt::ALT+Qt::CTRL+Qt::SHIFT+Qt::Key_G);
   pDebugMenu->insertItem("Dump Guild Members", this, SLOT(dumpGuild()), Qt::ALT+Qt::CTRL+Qt::SHIFT+Qt::Key_E);
